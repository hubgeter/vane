...
from vane.runners.ray.fragment_submission_window import release_fte_partition_submission
...
class FteWorkerSubmissionMixin:
    if TYPE_CHECKING:
        ...
        _request_fte_worker_reservation_for_partition: Callable[..., bool]
        ...
        *,
        ...
        def request_worker_reservation(partition: Any) -> bool:
            ...
            if fragment_execution is None:
                ...
                return False
            return bool(
                self._request_fte_worker_reservation_for_partition(
                    query_id,
                    fragment_id,
                    fragment_execution,
                    partition,
        ...
        def abandon_attempt_admission(partition: Any) -> None:
            release_fte_partition_submission(
                query_id,
                fragment_id,
                partition.task_id.partition_id,
