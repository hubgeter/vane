...
class DuckDBPyConnection:
    ...
    def from_csv_auto(
        ...
        lineterminator: str | CSVLineTerminator | None = None,
    ...
    def from_datasource(self, source: object) -> DuckDBPyRelation: ...
    ...
    def table_function(
        self, name: str, parameters: object = None, *, named_parameters: dict[str, object] | None = None
    ) -> DuckDBPyRelation: ...
    def tensor_type(
        self, type: sqltypes.DuckDBPyType, shape: Sequence[typing.SupportsInt]
    ) -> sqltypes.DuckDBPyType: ...
    ...
    @property
    def description(self) -> lst[tuple[str, sqltypes.DuckDBPyType, None, None, None, None, None]] | None: ...
    @property
...
class DuckDBPyRelation:
    ...
    def show(
        ...
        *,
        ...
        render_mode: RenderMode | str | int | None = None,
    ) -> None: ...
...
class Expression:
    ...
    def cast(self, type: str | sqltypes.DuckDBPyType) -> Expression: ...
...
class Statement:
    def __init__(self, _nonconstructible: Never) -> None: ...
    @property
    def expected_result_type(self) -> lst[ExpectedResultType]: ...
    @property
...
def _datasource_factory_registry_state_for_test() -> dict[str, typing.Any]: ...
...
def get_or_create_runner() -> _Runner: ...
def get_or_infer_runner_type() -> str: ...
def get_runner() -> _Runner | None: ...
def get_table_names(
...
def set_runner_local(
    ...
    max_running_tasks: object = None,
    execution_mode: object = None,
) -> _Runner: ...
def set_runner_ray(
    address: object = None,
    noop_if_initialized: bool = False,
    max_task_backlog: object = None,
) -> _Runner: ...
def sql(
    query: Statement | str,
    *,
...
def table_function(
    ...
    parameters: object = None,
    *,
    named_parameters: dict[str, object] | None = None,
    connection: DuckDBPyConnection | None = None,
) -> DuckDBPyRelation: ...
def teardown_runner() -> None: ...
def tensor_type(
    type: sqltypes.DuckDBPyType,
    shape: Sequence[typing.SupportsInt],
    *,
    connection: DuckDBPyConnection | None = None,
) -> sqltypes.DuckDBPyType: ...
