...
#include "vane_python/pybind11/conversions/explain_enum.hpp"
#include "vane_python/pybind11/conversions/render_mode_enum.hpp"
#include "vane_python/pybind11/conversions/null_handling_enum.hpp"
#include "vane_python/pybind11/dataframe.hpp"
...
public:
	...
	void ToLance(const string &uri, const string &mode = "create", uint64_t max_rows_per_file = 1024ULL * 1024ULL,
	             uint64_t max_rows_per_group = 1024ULL,
	             uint64_t max_bytes_per_file = 90ULL * 1024ULL * 1024ULL * 1024ULL,
	             const string &data_storage_version = "2.2");
